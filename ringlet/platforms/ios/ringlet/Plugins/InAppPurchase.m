...
{
	NSString *state, *error, *transactionIdentifier, *transactionReceipt, *productId, *expirationdate;
	NSInteger errorCode;
    ...
    for (SKPaymentTransaction *transaction in transactions)
    {
		...
		NSString *js = [NSString
            stringWithFormat:@"InAppPurchase.prototype.updatedTransactionCallback.apply(InAppPurchase.prototype, %@)",
