...
class BootStrap {
    ...
    def init = { servletContext ->
        if(User.count()==0){
            ...
            for (i in 1..11){
                new User(username: "user"+i+"@ringlet.me", passwordHash: new Sha256Hash("user"+i).toHex(), name: "User"+i, phone: "888888"+i, bio: "I am the user number "+i, location: [37.33233141d+i, -122.031286d], gender: UserGender.MALE).save(flush: true)
            }
        }
