...
class BootStrap {
    ...
    def init = { servletContext ->
        if(User.count()==0){
            ...
            User admin = new User(username: "admin@ringlet.me", passwordHash: new Sha256Hash("admin").toHex(), name: "Administrator", phone: "88888888", bio: "I am the Administrator", location: [37.33233141d, -122.031286d], friends: [2,3,4], gender: UserGender.MALE,photos: [1l,2l,11l,12l,21l]).save(flush: true)
