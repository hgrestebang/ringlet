...
class BootStrap {
    ...
    def init = { servletContext ->
        if(User.count()==0){
            new User(username: "admin@ringlet.me", passwordHash: new Sha256Hash("admin").toHex(), name: "Administrator", phone: "88888888", bio: "I am the Administrator", location: [37.33233141d, -122.031286d], friends: [2,3,4], usersBlocked: [5,6], gender: UserGender.MALE).save(flush: true)
            for (i in 1..8){
